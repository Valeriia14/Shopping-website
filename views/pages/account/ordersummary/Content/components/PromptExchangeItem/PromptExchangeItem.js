...
import { formStructure } from "./ExchangeFormConfig";
      ...
      >
        <div className={classes.paper}>
          ...
          <Box mt={4}>
            ...
            <PromptProductTable label="Exchange" item={itemData} />
            <SearchCatalogue item={itemData} onSelect={handleItemSelected} />
          </Box>
          <Box mt={4}>
