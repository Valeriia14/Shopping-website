import { number_or_zero } from "@kidztime/utilities";
...
export class QueryOptions implements FindOptions {
  ...
  filter_date(dates: FilterDateOptions = {}, column = "created_at") {
  ...
  filter_price(dates: FilterPriceOptions = {}, column = "base_price") {
